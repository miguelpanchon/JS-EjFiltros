function FpaintProducts() {
  //folder where you have the pictures
  //if it has to be change location because of Vite, it only has to be changed here
  var imgPath = "./img/capturas/"
